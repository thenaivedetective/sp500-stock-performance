"""
RESEARCH QUESTION 1: Temporal Entropy Analysis
===============================================
...
Methodology:
For each minute of the day (e.g., 7:00 AM), collect the activity levels 
across all days, calculate Shannon entropy for that minute slot, repeat 
for all 1440 minutes, then average these entropies. Lower average entropy 
indicates regular routines (same activity at same time daily), while higher 
entropy indicates chaotic schedules (unpredictable activity timing).
...
print("="*80)
print("RESEARCH QUESTION 1: TEMPORAL ENTROPY ANALYSIS")
print("="*80)
...
# Discretize METs to activity levels
def mets_to_level(mets):
    """Convert METs to discrete activity level (0,1,2,3)"""
    if pd.isna(mets):
        return np.nan
    if mets < 15:
...
df_1987['activity_level'] = df_1987['activities_calories_mets'].apply(mets_to_level)
df_2116['activity_level'] = df_2116['activities_calories_mets'].apply(mets_to_level)
...
print("\nActivity level discretization:")
print("  Level 0: METs 10-15  (Resting/Sleeping)")
print("  Level 1: METs 15-25  (Light activity)")
print("  Level 2: METs 25-40  (Moderate activity)")
print("  Level 3: METs 40+    (Vigorous activity)")
...
axes[0].set_title('FS1987 - Temporal Entropy Profile Across 24 Hours', 
...
axes[1].set_title('FS2116 - Temporal Entropy Profile Across 24 Hours', 
                  fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('temporal_entropy_profiles.png', dpi=300, bbox_inches='tight')
print("✓ Saved: temporal_entropy_profiles.png")
...
ax.set_title('Comparison of Average Temporal Entropy Between Participants', 
             fontsize=14, fontweight='bold')
...
ax.set_title('Temporal Entropy by Time of Day - Participant Comparison', 
             fontsize=14, fontweight='bold')
ax.set_xticks(x)
...
plt.tight_layout()
plt.savefig('entropy_by_timeofday.png', dpi=300, bbox_inches='tight')
print("✓ Saved: entropy_by_timeofday.png")
...
entropy_profile_1987.to_csv('FS1987_entropy_profile.csv', index=False)
entropy_profile_2116.to_csv('FS2116_entropy_profile.csv', index=False)
print("✓ Saved: FS1987_entropy_profile.csv")
print("✓ Saved: FS2116_entropy_profile.csv")
...
summary_results.to_csv('temporal_entropy_summary.csv', index=False)
...
print("="*80)
print("\nGenerated files:")
print("  1. temporal_entropy_profiles.png - 24-hour entropy profiles")
print("  2. entropy_comparison.png - Overall comparison")
print("  3. entropy_by_timeofday.png - Time-of-day analysis")
print("  4. FS1987_entropy_profile.csv - Detailed data for FS1987")
print("  5. FS2116_entropy_profile.csv - Detailed data for FS2116")
print("  6. temporal_entropy_summary.csv - Summary statistics")
print("="*80)
