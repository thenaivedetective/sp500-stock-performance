...
\begin{itemize}
    ...
    \item \textbf{Spanish}: \textit{Don Quijote} by Miguel de Cervantes (1,246 characters)
...
Spanish & 1,246   & 36 & 4.250000 & 0.850000 \\
...
\begin{itemize}
    \item \textbf{English} (4.478 bits): Highest entropy, most diverse symbol distribution
    \item \textbf{Arabic} (4.471 bits): Middle entropy
    \item \textbf{Spanish} (4.250 bits): Lowest entropy, most predictable symbol distribution
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{English} (0.955 bits): Moderate MI
    \item \textbf{Spanish} (0.850 bits): Lowest MI, weakest sequential dependencies
\end{itemize}
...
\textbf{2. Arabic's High Mutual Information:} Arabic shows significantly higher mutual information (1.40 bits) compared to English and Spanish. This may be due to:
\begin{itemize}
...
\textbf{3. Latin Alphabet Languages:} English and Spanish, both using Latin alphabets, show similar MI values (0.85-0.95 bits), suggesting comparable sequential structure.

\textbf{4. Alphabet Size Effect:} Arabic has fewer unique symbols (40) compared to English (90) and Spanish (36), yet maintains similar entropy by having stronger sequential dependencies.
...
This analysis revealed that while English, Spanish, and Arabic have similar information entropy (~4.5 bits), they differ significantly in mutual information. Arabic exhibits the strongest sequential dependencies, while Spanish shows the weakest. This highlights how different writing systems and linguistic structures can achieve similar overall complexity through different organizational principles.
